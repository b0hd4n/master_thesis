...
\def\todo#1{\XXX{TODO: #1}} % what should be done
\def\fix#1{\XXX{FIX: #1}} % fix after review
\def\edit#1{\textcolor{blue}{TO EDIT: #1}} % check grammar, wording
...
% \dirmany{En}{De, Fr} -  En->{De, Fr}
\def\dirmany#1#2{#1$\rightarrow$$\{$#2$\}$}
% \dirmanyrev{De, Fr}{En} -  {De, Fr}->En
\def\dirmanyrev#1#2{$\{$#1$\}$$\rightarrow$#2}
