...
\begin{figure}[h]
	...
	\mycaption{%
		...
		\emph{Left}: BLEU score for En\to{}Bg translation direction is monitored with
		...
		BLEU on En\to{}Bg validation set (axis \emph{Y}) vs.
		update steps (colos with scale at the top).

		\emph{Right}: Individual models' En\to{}Bg validation BLEU scores.
	}
...
\begin{figure}[h]
	...
	\mycaption{%
		...
		is compared with geometric mean of BLEU scores for each of target languages.
