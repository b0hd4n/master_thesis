...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\columnwidth]{../img/no_improvement_example.png}
	\mycaption{No improvement on validation set}{
		This is one of the early models (\dir{En}{Fi} in this case).
		\todo{Blue: asdf, red: asdf, green: asdf.}
		As can be seen, if the model was stopped by BLEU metric,
		it would have 21.3 BLEU. After 
	}
	\label{fig:no_improvement_example}
\end{figure}
